...
void VisitSolver::loadSolver(string *parameters, int n){
  ...
  string waypoint_file = "/root/AI4RO_II/AIROII_2/visits/visits_domain/waypoint.txt";
  parseWaypoint(waypoint_file);

  string landmark_file = "/root/AI4RO_II/AIROII_2/visits/visits_domain/landmark.txt";
